...
def prepare_dataset():
    ...
    unlabeled_train_dataset = unlabeled_train_dataset.filter(lambda img, label: (label == 2 or label == 3))
    ...
    labeled_train_dataset = labeled_train_dataset.filter(lambda img, label: (label == 2 or label == 3))
    ...
    test_dataset = test_dataset.filter(lambda img, label: (label == 2 or label == 3))
