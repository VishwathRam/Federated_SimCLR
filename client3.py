...
def prepare_dataset():
    ...
    unlabeled_train_dataset = unlabeled_train_dataset.filter(lambda img, label: (label == 4 or label == 5))
    ...
    labeled_train_dataset = labeled_train_dataset.filter(lambda img, label: (label == 4 or label == 5))
    ...
    test_dataset = test_dataset.filter(lambda img, label: (label == 4 or label == 5))
