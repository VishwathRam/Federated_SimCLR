...
def prepare_dataset():
    ...
    unlabeled_train_dataset = unlabeled_train_dataset.filter(lambda img, label: (label == 6 or label == 7))
    ...
    labeled_train_dataset = labeled_train_dataset.filter(lambda img, label: (label == 6 or label == 7))
    ...
    test_dataset = test_dataset.filter(lambda img, label: (label == 6 or label == 7))
